  ...
  return (
    <div className="mt-6 p-4 bg-gray-100 rounded-md">
      ...
      <div className="flex flex-row text-lg">
        <div className='pr-5 border-r'>✅ Yes votes: <span className="font-semibold">{noVotes}</span></div>
        <div className='pr-5 pl-5 border-r'>❌ No votes: <span className="font-semibold">{yesVotes}</span></div>
